...
| native ELF | `kotoba-lang/tender-native` | sealed native / ELF | ns `kototama.native.executor`; GitHub name is historical |
| Component engine | `kotoba-lang/tender-component` | admitted Component | Rust/Wasmtime micro-TCB must not enter kototama core (ADR-2607266000 D4) |
